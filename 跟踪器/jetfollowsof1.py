...
pygame.display.set_caption("Missile tracking simulation system")
missile = pygame.image.load('F:/桌面壁纸/catchaim.png').convert_alpha()
...
while True:
    ...
    section = velocity*time    # 每个时间片移动的距离
    sina = (y1 - y)/distance
    cosa = (x - x1)/distance
